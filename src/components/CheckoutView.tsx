...
import { divisions, districts, thanas, cityCorporations } from '../data/bangladeshAreas';
...
export default function CheckoutView({
  ...
  if (appliedPromoCode === 'WELCOME10') {
    ...
    discountAmount = districtId === 'dhaka_dist' ? 5.00 : 0;
  }

  const grandTotal = Math.max(0, Math.round((subtotal + deliveryFee - discountAmount) * 100) / 100);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const selectedCityCorp = isDhakaDistrict
      ? cityCorporations.find(cc => cc.id === cityCorpId)?.name || ''
      : '';
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="rounded-none border border-[#EEEEEE] bg-white p-6 sm:p-8">
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-5">
              {error && (
                <div className="rounded-none border border-black bg-white p-4 text-xs font-bold uppercase tracking-wider text-black" id="checkout-error">
                  {error}
                </div>
              )}
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {/* Division Picker */}
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-[0.15em] text-[#717171] mb-2" id="checkout-division-label">
                      Division *
                    </label>
                    <select
                      value={divisionId}
                  ...
                  {/* District Picker */}
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-[0.15em] text-[#717171] mb-2" id="checkout-district-label">
                      District *
                    </label>
                    <select
                      value={districtId}
                  ...
                  {/* Thana Picker */}
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-[0.15em] text-[#717171] mb-2" id="checkout-thana-label">
                      Thana / Upazila *
                    </label>
                    <select
                      value={thanaId}
                ...
                {districtId === 'dhaka_dist' && (
                  <div className="bg-[#FAF9F6] border border-black/5 p-4 animate-in fade-in slide-in-from-top-2 duration-200">
                    <label className="block text-[10px] font-bold uppercase tracking-[0.15em] text-black mb-2" id="checkout-citycorp-label">
                ...
                <div>
                  <label className="block text-[10px] font-bold uppercase tracking-[0.15em] text-[#717171] mb-2" id="checkout-streetaddress-label">
                ...
                <div className="rounded-none border border-black bg-white p-5 relative flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center space-x-2">
                      <span className="text-xs font-bold uppercase tracking-wider text-black">Cash on Delivery (COD)</span>
                    ...
                    <p className="text-xs text-[#717171] mt-2 leading-relaxed">
                      Zero upfront risks. Hand over cash only after successfully receiving and reviewing your items from the parcel courier.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-6 border-t border-[#EEEEEE] pt-6">
              ...
              {appliedPromoCode ? (
                <div className="flex items-center justify-between border border-black bg-black text-white p-3 mb-4 animate-in fade-in duration-200">
                  <div className="min-w-0">
                    <span className="text-[9px] font-bold uppercase tracking-wider block opacity-70">Code Applied</span>
              ...
              {promoSuccess && (
                <p className="text-[10px] text-green-600 font-bold mb-4 animate-in fade-in duration-150" id="promo-success-msg">
                  {promoSuccess}
                </p>
              )}
                ...
                <div className="space-y-2">
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[8px] font-bold uppercase tracking-wider bg-black text-white px-1.5 py-0.5">10% OFF</span>
                    </div>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[8px] font-bold uppercase tracking-wider bg-black text-white px-1.5 py-0.5">FREE SHIPPING</span>
                    </div>
                  ...
                  {subtotal >= 100 && (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[8px] font-bold uppercase tracking-wider bg-black text-white px-1.5 py-0.5">15% OFF</span>
                      </div>
                  ...
                  {districtId === 'dhaka_dist' && (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[8px] font-bold uppercase tracking-wider bg-black text-white px-1.5 py-0.5">FLAT $5 OFF</span>
                      </div>
