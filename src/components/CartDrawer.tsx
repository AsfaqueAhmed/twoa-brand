...
interface CartDrawerProps {
  ...
  onClose: () => void;
  cartItems: CartItem[];
  onUpdateQuantity: (productId: string, quantity: number, selectedSize?: string, selectedVariant?: ProductVariant) => void;
  onRemoveItem: (productId: string, selectedSize?: string, selectedVariant?: ProductVariant) => void;
  onCheckout: () => void;
}
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-baseline space-x-1.5 mt-0.5">
                            ...
                            <span className="text-[10px] text-[#717171] font-normal font-sans">
                              each
                            </span>
                          </div>
