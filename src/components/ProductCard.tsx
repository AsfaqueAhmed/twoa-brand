  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-3 sm:p-5">
        ...
        {/* Short Description */}
        <p className="mt-1 text-xs text-[#717171] line-clamp-2 leading-relaxed">
          {product.description}
        </p>
        ...
        <div className="mt-auto pt-4 flex items-center justify-between border-t border-[#EEEEEE]">
          <div>
            <span className="text-[9px] text-[#717171] block font-bold uppercase tracking-[0.15em] leading-none mb-1">Price</span>
