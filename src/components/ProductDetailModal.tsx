import { X, Star, ShoppingBag, CheckCircle, Ruler } from 'lucide-react';
...
interface ProductDetailModalProps {
  ...
  onClose: () => void;
  onAddToCart: (product: Product, quantity: number, selectedSize?: string, selectedVariant?: ProductVariant) => void;
}
...
export default function ProductDetailModal({ product, onClose, onAddToCart }: ProductDetailModalProps) {
  ...
  // Auto-select first size and variant when product changes
  useEffect(() => {
    if (product) {
      setQuantity(1);
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="relative w-full max-w-3xl max-h-[90vh] md:max-h-[85vh] overflow-y-auto md:overflow-hidden rounded-none border border-[#EEEEEE] bg-[#FDFDFD] shadow-2xl flex flex-col md:flex-row"
        ...
        >
          ...
          {/* Image side */}
          <div className="relative w-full aspect-[4/3] md:aspect-auto md:w-[45%] lg:w-[50%] md:h-full bg-[#F5F5F5] shrink-0" id="modal-product-image-container">
            <img
                    ...
                    {showSizeChart && (
                      ...
                      >
                        ...
                        <p className="text-[8px] text-[#919191] italic mt-3 leading-relaxed">
                          * Recommended to order your standard size for a boxy drape, or size down for a slimmer athletic silhouette.
                        </p>
                      </motion.div>
                    )}
                  </AnimatePresence>
